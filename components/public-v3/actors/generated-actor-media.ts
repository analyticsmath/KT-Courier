...
export const GENERATED_ACTOR_STATES: Record<string, GeneratedActorState> = {
  ...
  "white-truck:motion-energy": {
    ...
    groundContact: { x: 0.8565, y: 0.8002, source: "human-audited" },
    validPreviousStates: ["side-left"],
    validNextStates: ["side-left"],
    requiredOcclusion: "typography-occlusion",
  },
  ...
  "van:motion-transition": {
    ...
    action: "approach",
    family: "collection",
    groundContact: { x: 0.7719, y: 0.8177, source: "human-audited" },
    validPreviousStates: [],
    validNextStates: ["side-left"],
    requiredOcclusion: "scene-boundary",
  },
  ...
  "courier:hero-standing": {
    ...
    action: "idle",
    family: "portrait",
    groundContact: { x: 0.5401, y: 0.985, source: "human-audited" },
    validPreviousStates: [],
    validNextStates: [],
    requiredOcclusion: "scene-boundary",
  },
  "courier:full-body-one-parcel": {
    ...
    action: "carry",
    family: "portrait",
    groundContact: { x: 0.5365, y: 0.9829, source: "human-audited" },
    validPreviousStates: [],
    validNextStates: [],
    requiredOcclusion: "scene-boundary",
  },
  ...
  "courier:walk-right-one-parcel": {
    ...
    action: "travel",
    family: "street",
    groundContact: { x: 0.6738, y: 0.9544, source: "human-audited" },
    validPreviousStates: [],
    validNextStates: [],
    requiredOcclusion: "scene-boundary",
  },
  "courier:walk-left-one-parcel": {
    ...
    action: "travel",
    family: "arrival",
    groundContact: { x: 0.3717, y: 0.9565, source: "human-audited" },
    validPreviousStates: [],
  ...
  "courier:look-left-approach": {
    ...
    action: "approach",
    family: "collection",
    groundContact: { x: 0.6894, y: 0.9786, source: "human-audited" },
    validPreviousStates: [],
  ...
  "courier:lift-parcel": {
    ...
    action: "load",
    family: "collection",
    groundContact: { x: 0.6796, y: 0.9779, source: "human-audited" },
  ...
  "courier:loading-unloading": {
    ...
    action: "load",
    family: "collection",
    groundContact: { x: 0.6558, y: 0.9857, source: "human-audited" },
  ...
  "red-truck:centered-hero": {
    ...
    action: "idle",
    family: "freight",
    groundContact: { x: 0.5, y: 0.8002, source: "human-audited" },
    validPreviousStates: ["side-right"],
    validNextStates: [],
    requiredOcclusion: "scene-boundary",
  },
  ...
  "red-truck:curtain-open": {
    ...
    action: "open",
    family: "freight",
    groundContact: { x: 0.6799, y: 0.8398, source: "human-audited" },
    validPreviousStates: ["side-right"],
    validNextStates: [],
    requiredOcclusion: "door-sequence",
  },
