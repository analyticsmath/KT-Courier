...
export const HOME_BEATS = {
  ...
  marketplace: {
    readCurrent: [0, 0.2],
    railMove: [0.2, 0.65],
    railSettle: [0.65, 0.72],
    backdropTakeover: [0.72, 0.88],
    readIncoming: [0.88, 1],
  },
  fan: {
    imageArrives: [0, 0.12],
    spread: [0.12, 0.3],
    fullHold: [0.3, 0.58],
    counterMotion: [0.58, 0.68],
    compress: [0.68, 0.82],
    selectedHold: [0.82, 0.88],
    parcelHandoff: [0.88, 1],
  },
  preparation: {
    transfer: [0, 0.18],
    settle: [0.18, 0.3],
  ...
  collection: {
    street: [0, 0.1],
    vanApproach: [0.1, 0.37],
    brake: [0.37, 0.45],
    vanHold: [0.45, 0.59],
    door: [0.59, 0.72],
    courierApproach: [0.7, 0.79],
    lift: [0.79, 0.86],
    load: [0.86, 0.94],
    resolved: [0.94, 1],
    liftMask: [0.785, 0.815],
    loadMask: [0.855, 0.885],
  },
  custody: {
    merchant: [0, 0.18],
