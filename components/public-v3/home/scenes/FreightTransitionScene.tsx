...
export function FreightTransitionScene() {
  ...
  return (
    <section className={`${styles.chapter} ${styles.freight}`} data-kt-scene="freight" aria-labelledby="freight-heading" style={{ "--kt-home-budget": `${chapterBudgetVh("freight")}svh`, "--kt-home-mobile-budget": `${mobileChapterBudgetVh("freight")}svh` } as React.CSSProperties}>
      <div className={styles.sticky} data-home-sticky-stage>
        <div className={styles.freightStage}>
          ...
          <div className={styles.freightCopy} data-freight-copy><p className={styles.eyebrow}>Business movement</p><h2 className={styles.heading} id="freight-heading">From parcels to business movement.</h2><p className={styles.body}>Scheduled collections, documents, parcels and stock movement, connected by the same delivery network.</p></div>
