...
export function FinaleScene({ className = "" }: FinaleSceneProps) {
  ...
  return (
    <footer
      ...
      style={{ "--kt-home-budget": chapterBudgetVh("finale"), "--kt-home-mobile-budget": mobileChapterBudgetVh("finale") } as React.CSSProperties}
    >
      <div className="kt-home-sticky-stage kt-home-finale-sticky">
      {/* 1. Upper Utility Layer: Brand statement & subordinate directory */}
      <div data-motion="finale-utility" className={styles.finaleUtility}>
      ...
      <div className={styles.finaleIdentity}>
        ...
        <p className={styles.finaleMotto}>
      ...
      <div data-motion="finale-legal" className={styles.finaleLegal}>
