  ...
  return (
    <article className={styles.page}>
      ...
      <section className={styles.contractSection} aria-labelledby="developer-contract-title">
        <div className={styles.inner}>
          <div><h2 id="developer-contract-title">See the exact route and method contract.</h2><p className={styles.bodyCopy}>The OpenAPI resource is served from the canonical checked-in contract. It is documentation, not a browser API console.</p></div>
