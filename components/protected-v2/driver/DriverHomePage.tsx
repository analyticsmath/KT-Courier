...
export function DriverHomePage({ driver, assignments, activity }: { driver: DriverSelfDto; assignments: readonly DriverAssignmentDto[]; activity?: React.ReactNode }) {
