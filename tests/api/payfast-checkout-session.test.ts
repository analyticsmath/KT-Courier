...
describe("Payment checkout-session API contract", () => {
  ...
  it("selects Paystack server-side and accepts no provider selection", () => expect(route).toContain('provider: "PAYSTACK"'));
