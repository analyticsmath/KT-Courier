...
export const SYSTEM_SETTING_CATALOG: Record<string, SystemSettingDefinition> = {
  ...
  "orders.cod_max_amount": mutable("orders.cod_max_amount", SystemSettingType.STRING, "1500.00"),
  ...
  "pricing.default_volumetric_divisor": mutable("pricing.default_volumetric_divisor", SystemSettingType.NUMBER, 5000, { minimum: 1, maximum: 100000 }),
