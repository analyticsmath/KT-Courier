export type DispatchEligibilityReason =
  ...
  | "DRIVER_REGION_MISMATCH" | "DRIVER_CAPACITY_REACHED" | "ORDER_ALREADY_ASSIGNED";

export function evaluateDriverEligibility(input: { userActive: boolean; profileActive: boolean; available: boolean; regionMatch: boolean; activeLoad: number; capacity: number; orderAlreadyAssigned?: boolean }) {
