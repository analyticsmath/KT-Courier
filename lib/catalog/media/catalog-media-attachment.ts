...
import { assertCatalogMediaCounts, assertCatalogMediaPurposeRole, assertCatalogMediaRole, type CatalogMediaPurpose } from "@/lib/catalog/media/catalog-media-policy";
...
export function assertCatalogMediaAttachment(input: {
  ...
  assertCatalogMediaPurposeRole(input.asset.purpose, input.role as any);
