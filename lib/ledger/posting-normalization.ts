...
const JOURNAL_TYPES = new Set<LedgerJournalTypeCode>(["GENERAL", "ACCOUNT_TRANSFER", "OPENING_BALANCE", "REVERSAL", "EXTERNAL_PAYMENT_RECEIPT", "WITHDRAWAL_RESERVE", "WITHDRAWAL_RELEASE", "WITHDRAWAL_PAYOUT", "COMMISSION_ACCRUAL", "COMMISSION_REVERSAL"]);
