...
import { normalComposeProject, runCompose, runDocker, safeError, safeLog, startDisposableComposeWithPortRetry, waitForServiceHealth } from "./docker-common.mjs";
...
function buildEnv(port) {
  return {
    ...
    PAYFAST_MERCHANT_ID: "integration-merchant-id",
    PAYFAST_MERCHANT_KEY: "integration-merchant-key",
    PAYFAST_PASSPHRASE: "integration-private-passphrase",
    PAYFAST_CREDENTIAL_VERSION: "integration-sandbox-v1",
    PAYMENT_PROXY_MODE: "single_trusted_proxy",
    PAYMENT_APP_ORIGIN: "https://payfast-confirmation.example.test",
    KT_PAYFAST_TEST_DEPENDENCIES: "deterministic-injected",
